...
function Navbar({ headerHeight, headerWidth }: NavbarProps) {
  ...
  return (
    <nav
      ...
      className={cn(
        "fixed top-(--header-offset-top) left-(--header-offset-left) w-1/2 p-4 flex flex-col justify-center items-center gap-3 rounded-xl bg-white transform transition-transform duration-300 md:relative md:inset-0 md:w-[unset] md:p-0 md:flex-row md:gap-6 md:translate-0 md:bg-[unset]",
        {
